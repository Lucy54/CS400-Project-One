...
//        }
    ...
    private void loadTitles() {
        File movieFile = null;
        try {
            movieFile = new File("src/main/java/DataWrangler/movie.txt");
    ...
    private void loadGenres() {
        File movieFile = null;
        try {
            movieFile = new File("src/main/java/DataWrangler/genre.txt");
            System.out.println(movieFile.getAbsolutePath());
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Couldn't find file...");
    ...
    private void loadYears() {
        File movieFile = null;
        try {
            movieFile = new File("src/main/java/DataWrangler/year.txt");
            System.out.println(movieFile.getAbsolutePath());
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Couldn't find file...");
    ...
    private void loadRatings() {
        File movieFile = null;
        try {
            movieFile = new File("src/main/java/DataWrangler/ratings.txt");
            System.out.println(movieFile.getAbsolutePath());
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Couldn't find file...");
